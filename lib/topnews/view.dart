...
import 'package:xavair/topnews/webview.dart';
...
class _TopnewsPageState extends State<TopnewsPage> {
  final logic = Get.put(TopnewsLogic());
  final state = Get.find<TopnewsLogic>().state;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder<List<TopNewsMods>>(
        future: logic.getinformation(),
        builder: (context, snapshot) {
          if (snapshot.hasData && snapshot.data!.length > 0) {
            print(List<TopNewsMods>);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AnyLinkPreview(
                            ...
                            onTap: () {
                              Get.to(AllWebView(topNewsMods: snapshot.data![index],));
